            ...
            <section className="max-w-screen mx-auto p-4">
                ...
                <div className='lg:flex lg:justify-between my-10'>
                    <div className="">
                        ...
                        <h2 className='text-title lg:text-5xl text-3xl lg:my-8 my-4 lg:max-w-[600px] font-bold lg:leading-[60px]'>Notre expertise au service du plaisir.</h2>

                        <p className='lg:max-w-[630px] font-light text-secondaryText leading-7'>Chez Groupe ICI JEUX, notre objectif est de créer des environnements de jeu extérieur sûrs, stimulants et inclusifs pour les enfants. Nous sommes impatients de travailler avec vous pour concevoir le terrain de jeu de vos rêves.</p>

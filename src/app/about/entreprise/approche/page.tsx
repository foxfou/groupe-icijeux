    ...
    return (
        <main>
            ...
            <section className="max-w-screen mx-auto p-4">
                ...
                <h1 className='lg:text-4xl text-2xl font-medium mt-10'>Notre approche</h1>

                <h2 className='text-title lg:text-4xl text-2xl my-8 max-w-[950px] font-bold lg:leading-[50px] leading-[40px]'>Chez Groupe ICIJEUX, nos valeurs fondamentales sont la créativité, l'innovation, la nature et le jeu.</h2>
            ...
            <section className="max-w-screen mx-auto p-4">
                <div className="lg:flex lg:py-8 font-light justify-between">

                    <div className="flex-col leading-7">

                        <p className="lg:max-w-[540px]">Nous sommes passionnés par la création de jeux et 
                        ...
                        <p className="lg:max-w-[530px] my-6">La 
                    ...
                    <div>
                        ...
                        <p className="lg:max-w-[550px] my-4 ">Nous croyons également que la 
                        ...
                        <h1 className="my-8 lg:text-xl font-medium">Le jeu est notre raison d'être. </h1>

                        <p className="lg:max-w-[550px] mt-4 ">Nous voulons offrir des équipements de qualité qui favorisent le jeu libre, le développement des habiletés, la socialisation et le plaisir de passer du temps à l'extérieur. Nous sommes fiers de contribuer au bien-être des enfants et de leur offrir des souvenirs mémorables.</p>
